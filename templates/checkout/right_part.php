...
{elseif !$userinfo['firstname'] || $get['1'] != 'user_form'}
...
{/if}
{if $clientSecret}
  <div id="cc-info-stripe"{if !$display_cc_stripe} style="display: none;"{/if} secret="{$clientSecret}">
...
{/if}
{if $client_token}
  <div id="cc-info" class="display-none"{if !$display_cc_bt} style="display: none;"{/if}>
...
<center>
<button type="button" class="add2cart-product" id="card-submit">{lng[Place order]}</button>
</center>
{/if}
</form>
