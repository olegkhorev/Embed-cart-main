...
<h2><a href="{$url}" class="ec_ajax_link simple-button"><?php echo $b['title']; ?></a></h2>
</div>
<div class="image">
{if $b['imageid']}
<a href="{$url}" class="ec_ajax_link">
<?php
		$image = $b;
		$image['new_width'] = 250;
...
<div align="right">
<a class="ec_ajax_link" href="{$url}">{lng[Read blog]}</a>&nbsp;
<a href="{$url}#leave_comment">{lng[Leave a comment]}</a>
</div>
</div>
