...
<ul class="admin-tabs">
<li<?php if (empty($get['3'])) echo ' class="active"'; ?>><a href="{$current_location}/admin/category/<?php echo $category['categoryid']; ?>">{lng[Details]}</a></li>
{if $category['categoryid']}
<li<?php if ($get['3'] == 'banners') echo ' class="active"'; ?>><a href="{$current_location}/admin/category/<?php echo $category['categoryid']; ?>/banners">{lng[Banners]}</a></li>
{/if}
</li>
...
<form name="category_form" action="{$current_location}/admin/category/<?php echo $category['categoryid']; ?>/<?php echo $get['3']; ?>" method="post" enctype="multipart/form-data">
