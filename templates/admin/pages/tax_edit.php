...
if ($tax_rates) {
  ...
  <td>'.($t['zoneid'] == 0 ? "{lng[Default zone|escape]}" : "<a href='".$current_location."/admin/zones/".$t['zoneid']."'>".$t['zone_name']."</a>").'</td>
  <td align="center">
...
<tr>
  ...
  &nbsp;
<label>
<input type="checkbox" name="shipping" value="1"{if $rate_details['shipping']} checked{/if}> Apply to shipping
</label>
  </td>
</tr>
