...
<form name="login" method="POST" action="{$current_location}/admin/login" class="noajax">
...
&nbsp;
<a href="{$current_location}/admin/login" onclick="javascript: return restore_password();" class="register mdl-button mdl-js-button mdl-js-ripple-effect">Password recovery</a>
</div>
</form>