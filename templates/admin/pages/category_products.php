...
<a href="{$current_location}/admin/category/<?php echo $category['categoryid']; ?>">{lng[Modify category]}</a>

<br /><br />

<form action="{$current_location}/admin/category/<?php echo $category['categoryid']; ?>" method="post">
