...
<br /><br />
{lng[Total subscribers]}: <?php echo $subscribers ? $subscribers : '0';?> <a href="{$current_location}/admin/subscribtions/<?php echo $get['2']; ?>/export">{lng[Export]}</a>
<br /><br />
...
<button type="button" onclick="javascript: if (confirmed || confirm('{lng[This operation will delete selected letters.|escape]}', $ec(this))) submitForm(this, 'delete');">{lng[Delete selected]}</button>
</div>
</form>