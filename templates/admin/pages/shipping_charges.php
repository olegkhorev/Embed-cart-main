...
foreach ($shipping as $s)
	echo '<option value="'.$s['shippingid'].'"'.(($_GET['shippingid'] != "" && $_GET['shippingid'] == $s['shippingid']) ? ' selected="selected"' : '').'>'.func_trademark($s['shipping']).' ('.($s['destination'] == "I" ? "{lng[International|escape]}" : "{lng[National|escape]}").')</option>';
?>
</select>
...
<tr>
  ...
  <th><b><label for="sm_'.$z['zone']['zoneid'].'_'.$shipid.'">'.func_trademark($shipping_method['shipping']).' ('.($shipping_method['destination'] == "I" ? "{lng[International|escape]}" : "{lng[National|escape]}").')</label></b></th>
  <th align="right">
  </th>
</tr>
</table>
...
<?php
	foreach ($shipping as $s)
		echo '<option value="'.$s['shippingid'].'">'.func_trademark($s['shipping']).' ('.($s['destination'] == "I" ? "{lng[International|escape]}" : "{lng[National|escape]}").')</option>';
?>
  </select>
  </td>
</tr>
