{lng[Total subscribers]}: <?php echo $subscribers ? $subscribers : '0';?> <a href="{$current_location}/admin/subscribtions/export">{lng[Export]}</a>
<br /><br />
...
<?php
if ($get['3'] == 'new') {
	echo "<h3>{lng[New letter|escape]}</h3>";
} else {
...
<div class="fixed_save_button">
 <button type="submit">{lng[Save]}</button> &nbsp; <button type="button" onclick="javascript: if (confirmed || confirm('', $ec(this))) submitForm(this, 'send');">{lng[Send]}</button>
</div>
</td>
</tr>
