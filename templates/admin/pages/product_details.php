...
&nbsp; <button type="button" onclick="if (confirm('Are you sure?', $ec(this)) || confirmed) { document.pform.mode.value='clone'; document.pform.submit(); }">{lng[Clone product]}</button>
&nbsp; <button type="button" onclick="window.open('{$parnet_site_page}#!{if $product['cleanurl']}{$product['cleanurl']}{else}product/{$product['productid']}{/if}', '');">{lng[View product]}</button>
&nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" onclick="if (confirm('Are you sure?', $ec(this)) || confirmed) { document.pform.mode.value='delete'; document.pform.submit(); }">{lng[Delete]}</button>
{/if}
</div>
 </td>
</tr>
