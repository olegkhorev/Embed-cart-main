...
# LOCAL VERSION FOR DEVELOPMENT TO KEEP SAME SETTINGS FILE
	...
	# Location of parent site
	$parent_site_location = '{{parent_host}}';
} else {
	$sql_user = '{{sql_user}}';
	$sql_password = '{{sql_password}}';
	$sql_database = '{{sql_database}}';
...
# Web directory where Embed Cart located
$web_dir = '{{web_dir}}';

# HTML opener script - your site HTML page with Embed Cart
$parnet_site_page = '{{parent_page}}';
...
if ($_SERVER['HTTP_HOST'] != $http_domain) {
