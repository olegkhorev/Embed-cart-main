...
#	firstname LIKE "%".$q."%' OR lastname LIKE '%".$q."%' OR CONCAT(firstname, ' ', lastname) LIKE '%".$q."%' OR phone LIKE '%".$q."%'
#exit("SELECT * FROM users WHERE ".implode(" OR ", $where_sql)." ORDER BY firstname, lastname");
