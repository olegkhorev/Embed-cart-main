...
function doExport($import) {
	global $db, $config, $_SESSION, $export_dir, $http_location, $_POST, $current_location;
	...
	if ($import['categories']) {
		...
		fclose($fp);
		echo '<br />Data exported<br /><br /><a href="'.$current_location.'/admin/export/download" target="_blank">Download</a><br /><br /><a href="'.$current_location.'/admin/export">Go back</a>';
		exit;
	}
