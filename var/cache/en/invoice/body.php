...
<a href="<?php echo $current_location;?>/invoice/<?php echo $order['orderid'];?>/print" target="_blank" onclick="javascript: return print_invoice($ec(this));">Print invoice</a>
<a href="<?php echo $current_location;?>/invoice_pdf/<?php echo $order['orderid'];?>" target="_blank">Download PDF invoice</a>
<br /><br />
</div><?php } ?>
<?php } ?>
...
<?php } ?>
	<tr>
	 <td class="image hideonmobile" valign="top" style="padding-right: 10px;"><a href="<?php echo $parent_site_location;?><?php echo $parnet_site_page;?>#!/<?php echo $url;?>" class="ajax_link">
...
<?php } ?>
<?php } else  { ?>
<a href="<?php echo $parent_site_location;?><?php echo $parnet_site_page;?>#!/<?php echo $url;?>" class="ajax_link"><?php echo $v['name'];?></a>
<?php /* ?>
<?php if ($v['weight']) {?>
<br />
