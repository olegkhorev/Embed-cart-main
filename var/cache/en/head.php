...
<?php if ($login) {?>
<a href="<?php echo $parnet_site_page;?>#!wishlist" class="ec_ajax_link wishlist-link-force">Wishlist</a>
...
<a href="<?php echo $parnet_site_page;?>#!logout" class="ec_ajax_link head-top-border-link">Log out</a>
<?php } else  { ?>
...
<a href="<?php echo $parnet_site_page;?>#!register" class="ec_ajax_link head-top-border-link">Register</a>
<?php } ?>
</div>
...
<ul id="ec_menu">
 <li id="ec_menu-home"<?php if ($get['0'] == 'home') {?> class="active"<?php } ?>><a href="<?php echo $parnet_site_page;?>#!" class="parent-link">home</a></li>
...
<a href="<?php echo $parnet_site_page;?>#!/<?php if ($s2['cleanurl']) {?><?php echo $s2['cleanurl'];?><?php } else  { ?><?php echo $s2['categoryid'];?><?php } ?>"><?php echo $s2['title'];?></a>
 ...
 <?php } ?>
<?php } ?>
  <li id="ec_menu-brands"<?php if ($get['0'] == 'brands') {?> class="active"<?php } ?>><a class="parent-link" href="<?php echo $parnet_site_page;?>#!/brands">Brands</a>
<?php if ($brands_menu) {?>
<ul>
...
<?php /* ?>
  <li id="ec_menu-blog"<?php if ($get['0'] == 'blog') {?> class="active"<?php } ?>><a class="parent-link" href="<?php echo $parnet_site_page;?>#!/blog">Blog</a></li>
  <li id="ec_menu-page"<?php if ($get['0'] == 'page') {?> class="active"<?php } ?>><a class="parent-link" href="<?php echo $parnet_site_page;?>#!page/about.html">About CMS</a>
<ul>
 ...
 <li><a href="<?php echo $parnet_site_page;?>#!/page/MySQL-standards.html">MySQL standards</a></li>
  ...
  <li id="ec_menu-news"<?php if ($get['0'] == 'news') {?> class="active"<?php } ?>><a class="parent-link" href="<?php echo $parnet_site_page;?>#!news">News</a>
<?php */ ?>
...
<div class="search">
<input type="text" name="substring" value="<?php if ($substring) {?><?php echo escape($substring, 2);; ?><?php } ?>" placeholder="Search" autocomplete="off" />
<input type="image" src="<?php echo $current_location;?>/images/spacer.gif"/>
<div class="instant-search"><div class='enter-3-chars'>Enter 2 characters</div></div>
</div>
</form>
  </li>
</ul>
...
<?php /* ?><div class="ec_header-phone">Call Us <?php echo $config['Company']['company_phone'];?></div><?php */ ?>
<div id="ec_minicart">
<?php echo $minicart;?>
</div>
