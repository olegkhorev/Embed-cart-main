...
<?php /* ?>
<div data-productid="<?php echo $v['productid'];?>" class="quick-look main-button">Quicklook</div>
<?php */ ?>
</div>
<div class="ec_photo">
...
<a class="ec_save2wl" onclick="javascript: return <?php if ($login) {?>add_wishlist(<?php echo $v['productid'];?>);<?php } else  { ?>ec_alert('Please login first');<?php } ?>" href="javascript: void(0);"><img src="<?php echo $current_location;?>/images/favorite.png" width="23" alt="Добавить в избранное" /></a>
...
<span class="move2cart">Move me to cart</span>
<?php } ?>
<?php */ ?>
</div>
...
<?php if ($v['avail'] > 0) {?>
<button id="pid<?php echo $v['productid'];?>"><span><img src="<?php echo $current_location;?>/images/spacer.gif" alt="Добавить в корзину" /></span>Add to cart</button>
<?php } else  { ?>
...
<?php /* ?>
<br />
<a class="main-button" onclick="javascript: return <?php if ($login) {?>add_wishlist(<?php echo $v['productid'];?>);<?php } else  { ?>login_popup();<?php } ?>" href="javascript: void(0);">Add to wishlist</a>
<?php */ ?>
 </div>
</div>
<?php } ?>
