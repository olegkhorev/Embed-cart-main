...
<h1><a href="<?php echo $parnet_site_page;?>#!cart" class="ec_ajax_link back-to-cart"><img src="<?php echo $current_location;?>/images/back_arrow.png" alt="" /></a>Checkout</h1>
...
You can proceed anonymous or <a class="ec_ajax_link" href="<?php echo $parnet_site_page;?>#!login">Login</a>, <a class="ec_ajax_link" href="<?php echo $parnet_site_page;?>#!register">Register</a>.
</div>
...
<div align="center"><button class="add2cart-product">Continue</button></div>
</form>
</div>
 </td>
