...
<ul class="admin-tabs">
<li<?php  if (empty($get['3'])) echo ' class="active"'; ?>><a href="<?php echo $current_location;?>/admin/category/<?php  echo $category['categoryid']; ?>">Details</a></li>
<?php if ($category['categoryid']) {?>
<li<?php  if ($get['3'] == 'banners') echo ' class="active"'; ?>><a href="<?php echo $current_location;?>/admin/category/<?php  echo $category['categoryid']; ?>/banners">Banners</a></li>
<?php } ?>
</li>
