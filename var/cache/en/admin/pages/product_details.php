...
&nbsp; <button type="button" onclick="if (confirm('Are you sure?', $ec(this)) || confirmed) { document.pform.mode.value='clone'; document.pform.submit(); }">Clone product</button>
&nbsp; <button type="button" onclick="window.open('<?php echo $parnet_site_page;?>#!<?php if ($product['cleanurl']) {?><?php echo $product['cleanurl'];?><?php } else  { ?>product/<?php echo $product['productid'];?><?php } ?>', '');">View product</button>
&nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" onclick="if (confirm('Are you sure?', $ec(this)) || confirmed) { document.pform.mode.value='delete'; document.pform.submit(); }">Delete</button>
<?php } ?>
</div>
 </td>
</tr>
