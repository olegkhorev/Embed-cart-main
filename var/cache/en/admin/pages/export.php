...
<br />
Export product #<?php echo $_GET['product'];?>. <a href="<?php echo $current_location;?>/admin/export">Reset</a>
<hr />
<?php } ?>

<br />
<a href="<?php echo $current_location;?>/admin/export/download" target="_blank">Download last generated file</a>
