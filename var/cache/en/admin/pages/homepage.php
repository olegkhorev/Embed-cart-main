...
<ul class="admin-tabs">
<li<?php  if (empty($get['2'])) echo ' class="active"'; ?>><a href="<?php echo $current_location;?>/admin/homepage">Details</a></li>
<li<?php  if ($get['2'] == 'banners') echo ' class="active"'; ?>><a href="<?php echo $current_location;?>/admin/homepage/banners">Banners</a></li>
</li>
