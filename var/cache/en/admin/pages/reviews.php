...
<form method="POST" href="<?php echo $current_location;?>/admin/reviews?mode=search">
...
<form action="<?php echo $current_location;?>/admin/reviews" method="post" name="reviewsform">
...
<?php foreach ($reviews as $r) {?>
                <tr>
                        ...
                        <td valign="top" width="10%"><a href="<?php echo $current_location;?>/admin/products/<?php echo $r['productid'];?>" target="_blank"><?php echo $r['productid'];?>/<?php echo $r['sku'];?></a></td>
                </tr>
<?php } ?>
                <tr>
                        <td colspan="9"><br />
...
<button type="button" onclick="javascript: if (confirmed || confirm('This operation will delete selected reviews.', $ec(this))) submitForm(this, 'delete');">Delete selected</button>
</div>
                        </td>
                </tr>
        </table>
