...
<br /><br />
Total subscribers: <?php  echo $subscribers ? $subscribers : '0';?> <a href="<?php echo $current_location;?>/admin/subscribtions/<?php  echo $get['2']; ?>/export">Export</a>
<br /><br />
...
<button type="button" onclick="javascript: if (confirmed || confirm('This operation will delete selected letters.', $ec(this))) submitForm(this, 'delete');">Delete selected</button>
</div>
</form>