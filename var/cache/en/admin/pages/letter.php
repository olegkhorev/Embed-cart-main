Total subscribers: <?php  echo $subscribers ? $subscribers : '0';?> <a href="/admin/subscribtions/export">Export</a>
<br /><br />
...
<?php 
if ($get['3'] == 'new') {
	echo "<h3>New letter</h3>";
} else  {
	echo "<h3>".$letter['subject']."</h3>";
}
?>
...
<div class="fixed_save_button">
 <button type="submit">Save</button> &nbsp; <button type="button" onclick="javascript: if (confirmed || confirm('', $(this))) submitForm(this, 'send');">Send</button>
</div>
</td>
</tr>
...
<tr>
 <td valign="top"><b>Email address #1:</b></td>
 <td><input type="text" name="email1" value="<?php  echo $company_email; ?>" /></td>
</tr>

<tr>
 <td valign="top"><b>Email address #2:</b></td>
 <td><input type="text" name="email2" /></td>
</tr>

<tr>
 <td valign="top"><b>Email address #3:</b></td>
