...
if ($blogs) {
?>
<a href="<?php echo $current_location;?>/admin/blog/new">Add new</a>
<br /><br />
...
foreach ($blogs as $b) {
	...
	<td align="center"><a href="'.$current_location.'/admin/blog/'.$b['blogid'].'">'.$b['comments']." Blog comment(s) &gt;&gt;</a></td>
</tr>";
}
?>
</table>
...
<button type="button" onclick="javascript: if (confirmed || confirm('This operation will delete selected blogs with all messages.', $(this))) submitForm(this, 'delete');">Delete selected</button>
</div>
</form>
...
<tr>
 ...
 <td><div class="select-title">Author</div>
...
?>
<br />
 <a href="<?php  echo $current_location.'/admin/blog/'.$blog['blogid'].'/?mode=delete_image'; ?>">Delete image</a><br />
<?php 
}
?>
...
<tr>
 <td valign="top" class="hide-td-for-mdl"></td>
 <td><div class="select-title">Short description</div>
...
<tr>
 <td valign="top" class="hide-td-for-mdl"></td>
 <td><div class="select-title">Detailed description</div>
	<script>
		var editor;
...
<?php include SITE_ROOT."/var/cache/en/admin/common/navigation.php";?>
...
<a href="javascript: void(0);" onclick="javascript: if (confirm(\'Delete this comment?\', \'\', \''.$current_location.'/admin/blog/'.$get['2'].'/?deleteid='.$i['commentid'].'\'));">Delete</a> / <a href="javascript: void(0);" onclick="javascript: edit_comment(\''.$i['commentid'].'\');">Edit</a> / ';
	if ($i['active'] == "Y")
		echo '<a class="color-red" href="'.$current_location.'/admin/blog/'.$get['2'].'/?declineid='.$i['commentid'].'">Decline</a>';
	else 
		echo '<a class="blog-color-2" href="'.$current_location.'/admin/blog/'.$get['2'].'/?approveid='.$i['commentid'].'">Approve</a>';
	echo '&nbsp;&nbsp;
</div>
...
?>
<br /><center>No blog comments yet</center>
<?php 
}
?>
...
function edit_comment(id) {
	...
	document.blogform.btn.value="Save";
