...
<option value="A"<?php  if ($v['discount_type'] == 'A') echo ' selected'; ?>>Absolute</option>
</select>
	</td>
	...
	<td align="center" nowrap><label><input type="checkbox" name="posted_data[<?php  echo $v['coupon']; ?>][per_customer]" value="1"<?php  if ($v['per_customer']) echo ' checked'; ?> /> per customer</label></td>
	<td align="center">
...
<tr>
	<td colspan="6" align="center"><br />No discount coupons defined</td>
</tr>
...
<tr>
	<td colspan="6"><br /><h3>Add new</h3></td>
</tr>
...
<option value="A">Absolute</option>
	...
	<td align="center"><label><input type="checkbox" name="add_coupon[per_customer]" value="1" /> per customer</label></td>
	<td align="center">
