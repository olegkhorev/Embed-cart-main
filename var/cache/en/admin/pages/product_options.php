...
?>
<tr>
 <td colspan="6"><br><button type="submit">Update</button> <button type="button" onclick="submitForm(this, 'delete');">Delete selected</button></td>
</tr>
<?php 
}
?>
<tr>
 <td colspan="6"><br /><a href="<?php echo $current_location;?>/admin/products/<?php  echo $get['2']; ?>/options/add">Add new</a></td>
</tr>
</table>
<?php 
