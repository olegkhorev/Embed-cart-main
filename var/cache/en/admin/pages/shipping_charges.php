...
foreach ($shipping as $s)
	echo '<option value="'.$s['shippingid'].'"'.(($_GET['shippingid'] != "" && $_GET['shippingid'] == $s['shippingid']) ? ' selected="selected"' : '').'>'.func_trademark($s['shipping']).' ('.($s['destination'] == "I" ? "International" : "National").')</option>';
?>
</select>
...
<tr>
  ...
  <th><b><label for="sm_'.$z['zone']['zoneid'].'_'.$shipid.'">'.func_trademark($shipping_method['shipping']).' ('.($shipping_method['destination'] == "I" ? "International" : "National").')</label></b></th>
  <th align="right">
  </th>
</tr>
</table>
...
<?php 
	foreach ($shipping as $s)
		echo '<option value="'.$s['shippingid'].'">'.func_trademark($s['shipping']).' ('.($s['destination'] == "I" ? "International" : "National").')</option>';
?>
  </select>
  </td>
</tr>
