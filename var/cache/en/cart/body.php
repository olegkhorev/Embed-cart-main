<h1 class="ec_cart-h1">Your cart</h1>
<?php if ($products) {?>
...
<table width="100%">
<tr>
 <td><button<?php  if ($is_ajax) echo ' type="button"'; ?> class="update-cart">Update</button> &nbsp; <button type="button" class="ec_clear-cart main-button"<?php  if (!$is_ajax) echo ' onclick="self.location=\'cart/clear\'"'; ?>>Clear cart</button></td>
...
<?php } ?>
<div class="totals">
 <b>Total: <?php echo '<span class="currency">'.currency_symbol().'</span>'.price_format_currency($cart['total']); ?></b>
</div>
<br /><br />
<button class="checkout-link ec_ajax_link add2cart-product" href="<?php echo $parnet_site_page;?>#!checkout" type="button">Checkout</button></td>
</tr>
</table>
</form>
<?php } else  { ?><br /><br />
