...
<?php */ ?>
<div id="dcart"><img src="<?php echo $current_location;?>/images/dcart.png" alt="" /><br />Déplacer le produit ici</div>
<?php 
if (lng('Site title'))
...
<a class="all-link" href="/testimonials">Tous les témoignages</a>
<a class="leave-link" href="/testimonials/new">Écrire témoignage</a>
</div>
</div>
<?php */ ?>
...
<div class="testimonial">
<img src="/images/new/test.png" class="test-image" alt="Nos témoignages" />
<h2>Témoignages</h2>
<div class="message"><?php echo $testimonial['message'];?></div>
<div class="name"><?php echo $testimonial['name'];?></div>
<?php if ($testimonial['url']) {?>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Produits en vedette</li>
</ul>
</div>
...
<div class="carousel-pr" id="carousel-0">
 ...
 <?php include SITE_ROOT."/var/cache/fr/common/products.php";?>
     </div>
  </div>
</div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Best-sellers</li>
</ul>
</div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Les plus vues</li>
</ul>
</div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Les nouveaux arrivants</li>
</ul>
</div>
...
<div class="news-list">
<h2>Parcourez nos actualités</h2>
...
<br />
<a class="news-more ajax_link" href="<?php echo $url;?>">Voir l'article complet</a>
</div>
<div class="clear"></div>
<?php } ?>
<a href="/news" class="ajax_link">Toutes les news</a>
<br /><br />
</div>
<?php } ?>
...
<br />
<a class="news-more ajax_link" href="<?php echo $url;?>">Voir plein de blog</a>
</div>
<div class="clear"></div>

<a href="/blog" class="ajax_link">Tous les blogs</a>
<br /><br />
</div>
<?php } ?>
