...
<?php include SITE_ROOT."/var/cache/fr/left_menu.php";?>
<?php } ?>
</div>
...
<?php include SITE_ROOT."/var/cache/fr/ajax_container.php";?>
</div>
...
<div id="subscribe">
<input placeholder="Abonnez-vous à notre news ici..." type="text" id="sub-email" name="email" />
