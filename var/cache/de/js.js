...
var are_you_sure = "Sind Sie sicher?",
	mobile_screen = 700,
	instant_search_ajax,
	yes = "Ja",
	no = "Keine",
...
//						return false;
						...
						alert('Bitte warten, wir verbinden Sie zu PayPal');
					} else {
	...
	$('.apply_gc').click(function() {
		...
		$('.coupon_screen').html('<br/><div class="group"><input type="text" size="30" required /><span class="highlight"></span><span class="bar"></span><label>Geben Sie Ihre Geschenk-Karte-code-hier</label></div><div class="coupon-error"></div><button>Bewerben</button><br/><br/>');
	...
	$('.apply_coupon').click(function() {
		bc = false;
		var id = alert('<div class="coupon_screen"></div>', 1, '', 'coupon_alert');
		$('.coupon_screen').html('<br/>10% coupon: test<br/><br/><div class="group"><input type="text" size="30" required /><span class="highlight"></span><span class="bar"></span><label>Geben Sie Ihren Gutschein-code hier</label></div><div class="coupon-error"></div><button>Bewerben</button><br/><br/>');
    /*
...
function instant_search() {
	$('.search input').unbind('focus').focus(function() {
		var val = $(this).val();
		if (val.length < 2) {
			$('.instant-search').html("<div class='enter-3-chars'>Geben Sie 2 Zeichen</div>");
			return;
		}
...
//alert(s);
			...
			html += '</select>';
			if ($('.admin-area').size())
				$('#state').closest('td').html('<div class="select-title">Staat</div>'+html);
			else
