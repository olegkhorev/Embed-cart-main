...
<?php if ($config['theme_css']) {?>
<link id="custom_style" rel="stylesheet" href="/images/themes/<?php echo $config['theme_css'];?>.css" type="text/css" />
<?php } ?>
...
<?php include SITE_ROOT."/var/cache/de/left_menu.php";?>
<?php } ?>
</div>
...
<?php include SITE_ROOT."/var/cache/de/ajax_container.php";?>
</div>
...
<div id="subscribe">
<input placeholder="Abonnieren Sie unseren news finden Sie hier..." type="text" id="sub-email" name="email" />
