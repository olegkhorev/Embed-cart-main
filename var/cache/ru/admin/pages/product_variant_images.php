...
?>
<tr>
 <td colspan="3"><button>Обновить</button> <button type="button" onclick="submitForm(this, 'delete');">Удалить выбранные</button><br /><br /></td>
</tr>
</table>
<?php 
}
...
<button type="button" onclick="javascript: submitForm(this, 'upload');">Загрузить изображения</button>
 </td>
</tr>
</table>
</div>
