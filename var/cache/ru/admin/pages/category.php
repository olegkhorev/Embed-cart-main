...
<ul class="admin-tabs">
<li<?php  if (empty($get['3'])) echo ' class="active"'; ?>><a href="<?php echo $current_location;?>/admin/category/<?php  echo $category['categoryid']; ?>">Подробности</a></li>
<?php if ($category['categoryid']) {?>
<li<?php  if ($get['3'] == 'banners') echo ' class="active"'; ?>><a href="<?php echo $current_location;?>/admin/category/<?php  echo $category['categoryid']; ?>/banners">Баннеры</a></li>
<?php } ?>
</li>
...
<form name="category_form" action="<?php echo $current_location;?>/admin/category/<?php  echo $category['categoryid']; ?>/<?php  echo $get['3']; ?>" method="post" enctype="multipart/form-data">
...
?>
<tr>
 <td colspan="5" align="center">Нет баннеров для этой категории</td>
</tr>
<?php 
}
?>
...
<tr>
	<td height="10" class="FormButton" nowrap="nowrap">Позиция</td>
	<td width="10" height="10">&nbsp;</td>
	<td height="10">
...
<tr>
	<td height="10" nowrap="nowrap">Включено</td>
	<td width="10" height="10"></td>
	<td height="10">
...
<tr class="standard">
 <td valign="top" class="hide-td-for-mdl"></td>
	<td width="10" height="10">&nbsp;</td>
 <td><div class="select-title">Значок категории</div>
	<?php 
	if ($category_icon) {
		...
		echo '<br />';
?>
<label><input type="checkbox" name="delete_icon" value="1" /> Удалить значок</label><br /><br />
<?php 
	}
	?>
...
<button class="button-margin-left" type="button" onclick="javascript: submit_category();">Сохранить</button>
<?php 
if ($category && $new_category != 'Y') {
?>
&nbsp; <b>Расположение категории:</b>

<?php 
echo $categories_tree;
?>

<button type="button" onclick="javascript: submitForm(this, 'move');">Обновить</button>
<?php 
}
?>
</div>
