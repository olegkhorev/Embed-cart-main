  ...
  $ec(document).ready(function() {
	...
	$ec('.edit_album').on('click', function() {
		...
		if (ec_page == 'my_groups')
			...
			ec_alert('<div id="edit_'+i+'"><label><input type="radio" name="type" value="0"'+(tp == 0 ? ' checked' : '')+">публичный</label><br><label><input type='radio' name='type' value='1'"+(tp == 1 ? ' checked' : '')+">частный</label><br><label><input type='radio' name='type' value='2'"+(tp == 2 ? ' checked' : '')+">для_подписчиков</label><br><br>"+'<input type="text" value="'+$ec('.'+i).html()+'"><button>Сохранить</button></div>', '', '', 1, '', 1);

		else

			ec_alert('<div id="edit_'+i+'"><label><input type="radio" name="type" value="0"'+(tp == 0 ? ' checked' : '')+">публичный</label><br><label><input type='radio' name='type' value='1'"+(tp == 1 ? ' checked' : '')+">частный</label><br><label><input type='radio' name='type' value='2'"+(tp == 2 ? ' checked' : '')+">для друзей</label><br><label><input type='radio' name='type' value='3'"+(tp == 3 ? ' checked' : '')+">для_друзей_и_их_друзей</label><br><br>"+'<input type="text" value="'+$ec('.'+i).html()+'"><button>Сохранить</button></div>', '', '', 1, '', 1);
