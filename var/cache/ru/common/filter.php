...
<?php } ?>
<?php if ($_GET['filter']) {?>
<?php /* ?><a href="javascript: void(0);" class="reset_filter">Reset filter</a><?php */ ?>
<a href="<?php echo $parnet_site_page;?>#!/<?php echo $reset_filter_url;?>" class="ec_ajax_link reset_filter_url">Сбросить фильтр</a>
<?php } ?>
<?php /* ?>
<h4>Диапазон цен</h4>
