...
b. Follow your that domain+folder, for example
https://embed-cart.com/cart/install

Complete steps.

c. For development purposes open "includes/settings.php" and edit it per your needs.

DEVELOPMENT TRUE mean templates are always regenerated.

DEMO TRUE mean some params are not editable.

d. Admin area - a@a.com / 01230
